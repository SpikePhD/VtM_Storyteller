    ...
    def _build_prompt(self, payload_json: str) -> str:
        return "\n".join(
            [
                ...
                "Use dialogue_move to shape the line: react and banter should feel conversational, continue should invite the next beat, and clarify should repair or push back without echoing the player's words.",
                "If dialogue_move is continue, answer with a short handoff such as 'Go on.' or 'I'm listening.' rather than echoing the player's request back verbatim.",
